import { AppBar, Box, Container, IconButton, Toolbar, Typography,Button, duration } from "@mui/material"
import AdminPanelSettingsIcon from '@mui/icons-material/AdminPanelSettings';
import {motion} from 'framer-motion'
import Brightness4Icon from '@mui/icons-material/Brightness4';
import { useState } from "react";

// Create the Framer motion for Material UI Components
const MotionBox = motion(Box)
const MotionTypography = motion(Typography)

// Create the Variants For SVG Image
const svgVariants = {
    hidden : {
        rotate : -180
    },
...
export const Navbar = ({mode, setMode})=> {
    ...
    return(
        <MotionBox initial={{opacity : 0}} animate={{opacity : 1}} transition={{ delay : 0.5, duration : 1}} sx={{ flexGrow: 1 }}>
                <AppBar position="static" color="inherit">
                    <Toolbar>
                        ...
                        <Button href="/admin/add-item" >Add Item</Button>
                        <Button href="/admin/list-items">List Items</Button>
                        <Button href="/admin/order-items">Order Items</Button>
